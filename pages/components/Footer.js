  ...
  return (
        <footer className="opacity-90 relative bg-gray-200 rounded-t-lg shadow">
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-6">
                ...
                <span className="block text-sm sm:text-center text-gray-800">© 2023 <a href="#" class="hover:underline text-semibold hover:text-blue-700">GDSC GEU</a>. All Rights Reserved.</span>
            </div>
        </footer>
  )
}
